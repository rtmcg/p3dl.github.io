...
2. If a filament is loaded, select "Unload Filament."
    ...
    * Never leave the end of the filament hanging loose. Always secure it using the holes in the spool.
...
4. Clip the end of the filament off on an angle such that it has a fresh cleaved end that comes to a point.

5. On the printer select "Load Filament".

6. Follow the instructions, inserting the filament when it tells you to do so.

7. The printer will then extrude some filament to clean the nozzle, and will ask if the correct color is printing.
    * If yes, press yes.
